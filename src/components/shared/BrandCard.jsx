    ...
    >
      {b.logo_url && (
        <img
          ...
          loading="lazy"
          draggable={false}
          className="absolute inset-0 w-full h-full object-cover scale-105 blur-[1.5px] opacity-80 transition-transform duration-700 group-hover:scale-[1.1]"
        />
      )}
      ...
      {verified && (
        <div className="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-slateblue/85 text-creme text-[9px] tracking-[0.18em] uppercase backdrop-blur-sm">
          Verified
        </div>
      )}
